...
### use [ws2s.js](ws2s-js/)
```javaScript
var socket = new WS2S("wss://ws2s.feling.io/v2/").newSocket()
...
{
    "command": "sendb",// send bytes by base64
